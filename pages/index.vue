<template>
  <main
    class="container mb-4 grid grid-cols-12 grid-flow-row col-gap-6 row-gap-16"
  >
    ...
    <section
      id="intro"
      class="row-start-2 row-span-1 col-span-12 sm:col-start-2 sm:col-span-10 md:col-start-2 md:col-span-7 lg:col-start-2 lg:col-span-5"
      v-html="$md.render(intro)"
    />
    ...
    <ProjectCard
      ...
      :key="`project${index}`"
      :project="project"
      :class="{ 'md:col-start-4 lg:col-start-6': index % 2 === 0 }"
    />
