<template>
  <section
    ...
    class="row-span-2 col-span-12 md:col-span-9 lg:col-span-7 grid grid-cols-7 border border-gray-400 rounded-lg"
  >
    <img
      v-if="imageURL"
      :srcset="image.set"
    ...
    <q
      v-if="quote"
      class="col-span-7 text-center text-2xl italic font-light pt-2 pb-4"
    >
      {{ quote }}
    </q>
  </section>
