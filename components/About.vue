<template>
  <aside id="about" class="col-span-12 row-span-1 grid grid-cols-12 grid-flow-row gap-6">
    <img :srcset="image.set" :src="image.one" :alt="imageAlt" class="col-span-12 sm:col-span-4 lg:col-span-3 lg:col-start-2 row-span-1 sm:row-span-2 rounded-full w-full max-w-sm flex mx-auto sm:my-auto p-4" loading="lazy">
